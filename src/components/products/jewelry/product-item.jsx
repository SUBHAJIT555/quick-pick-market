...
const ProductItem = ({ product, suppressClickRef }) => {
  ...
  return (
    <article className="tb-product-card">
      <div className="tb-product-card__media">
        <button type="button" className="tb-product-card__img-btn" onClick={handleModalClick}>
          <Image
            src={img}
            alt={title}
            width={280}
        ...
        <div className="tb-product-card__actions" onPointerDown={stopDrag}>
          {isAddedToCart ? (
            <Link
              href="/cart"
      ...
      <div className="tb-product-card__body">
        <h3 className="tb-product-card__title">
          <button type="button" className="tb-product-card__title-btn" onClick={handleModalClick}>
            {title}
          </button>
        </h3>

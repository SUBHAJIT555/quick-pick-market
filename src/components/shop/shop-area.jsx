...
const ShopArea = memo(({ all_products, products, otherProps }) => {
  ...
  return (
    <>
      <section className="tp-shop-area dc-shop scs-shop pb-120">
        <div className="container">
          <div className="row g-4">
            <div className="col-xl-3 col-lg-4 scs-shop__sidebar-col">
              <div className="tp-shop-sidebar scs-shop__sidebar mr-10">
                {/* filter */}
                <PriceFilter
            ...
            <div className="col-xl-9 col-lg-8">
              <div className="tp-shop-main-wrapper scs-shop__main">
                <div className="tp-shop-top scs-shop__toolbar mb-45">
                  <div className="row">
                    <div className="col-xl-6 scs-shop__toolbar-left">
                      <ShopTopLeft
                        showing={products.length === 0 ? 0 : showing}
                        total={products.length}
                      />
                    </div>
                    <div className="col-xl-6 scs-shop__toolbar-right">
                      <ShopTopRight selectHandleFilter={selectHandleFilter} />
                    </div>
                  </div>
                </div>
                <div className="scs-shop__catalog">
                {products.length === 0 && <h2 className="scs-shop__empty">No products found</h2>}
                {products.length > 0 && (
                  <div className="tp-shop-items-wrapper tp-shop-item-primary scs-shop__grid">
                      ...
                      >
                        <div className="row">
                          {paginatedProducts.map((item) => (
                            <div
                              key={item._id}
                              className="col-xl-4 col-md-6 col-sm-6 scs-shop__col"
                            >
                ...
                {products.length > 0 && (
                  <div className="tp-shop-pagination scs-shop__pagination mt-20">

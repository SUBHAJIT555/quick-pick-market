...
const CategoryFilter = memo(({ setCurrPage, shop_right = false }) => {
  ...
  return (
    <>
      <div className="tp-shop-widget scs-shop-categories mb-50">
        <h3 className="tp-shop-widget-title">Categories</h3>
        <div className="tp-shop-widget-content">
          <div className="tp-shop-widget-categories scs-shop-categories__list">
            <ul className="scs-shop-categories__scroll">{content}</ul>
          </div>
        </div>
      </div>
    </>

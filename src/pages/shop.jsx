...
const ShopPage = () => {
  ...
  if (!isLoading && isError) {
    content = (
      <div className="scs-shop-page__status">
  ...
  return (
    <Wrapper>
      ...
      <div className="scs-shop-page__top">
        <div className="scs-shop-page__top-canvas" aria-hidden="true">
          <div className="scs-shop-page__top-grid" style={PAGE_HERO_GRID_STYLE} />
        </div>
        <div className="scs-shop-page__top-inner">
          <HeaderThree />
          <section className="scs-shop-page__hero">
            <div className="scs-shop-page__hero-inner">
              <nav className="scs-shop-page__breadcrumb" aria-label="Breadcrumb">
                <Link href="/">Home</Link>
                <span aria-hidden="true">/</span>
                <span>Shop</span>
              </nav>
              <h1 className="scs-shop-page__title">Shop</h1>
              <p className="scs-shop-page__lead">
                Browse our full collection, filter by category or price, and find what you need.
              </p>
            </div>
          </section>
        </div>
      </div>
      <div className="scs-shop-page__body">{content}</div>
      {hasProducts && (
        <ShopFilterOffCanvas
          all_products={products.data}
          otherProps={otherProps}
